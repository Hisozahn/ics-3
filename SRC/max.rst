   ...
   21BD                     402 _write_max:
                    ...
                    0001    409 	ar1 = 0x01
                    0000    410 	ar0 = 0x00
   21BD C0 09               411 	push	_bp
   21BF 85 81 09            412 	mov	_bp,sp
                            413 ;	SRC/max.c:52: unsigned char oldDPP = DPP;
                            414 ;	SRC/max.c:54: DPP     = MAXBASE;
                            415 ;	SRC/max.c:55: *regnum = val;
   21C2 AD 84               416 	mov	r5,_DPP
   21C4 75 84 08            417 	mov	_DPP,#0x08
   21C7 E5 09               418 	mov	a,_bp
   21C9 24 FD               419 	add	a,#0xfd
   21CB F8                  420 	mov	r0,a
   21CC E6                  421 	mov	a,@r0
   21CD F0                  422 	movx	@dptr,a
                            423 ;	SRC/max.c:56: DPP     = oldDPP;
   21CE 8D 84               424 	mov	_DPP,r5
